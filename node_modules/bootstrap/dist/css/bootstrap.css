 ...
 */
 ...
 .btn-check:checked + .btn-check:checked + .btn-primary,
 .btn-check:active + .btn-check:checked + .btn-primary, .btn-check:checked +
 .btn-check:active + .btn-primary,
 .btn-check:active +
 .btn-check:active + .btn-primary {
   color: #378dfc;
 ...
 .btn-check:checked + .btn-check:checked + .btn-secondary,
 .btn-check:active + .btn-check:checked + .btn-secondary, .btn-check:checked +
 .btn-check:active + .btn-secondary,
 .btn-check:active +
 .btn-check:active + .btn-secondary {
   color: #7b8ab8;
 ...
 .btn-check:active + .btn-check:checked + .btn-success, .btn-check:checked +
 .btn-check:active + .btn-success,
 .btn-check:active +
 .btn-check:active + .btn-success {
   color: #43cc29;
 ...
 .btn-check:checked + .btn-check:checked + .btn-info,
 .btn-check:active + .btn-check:checked + .btn-info, .btn-check:checked +
 .btn-check:active + .btn-info,
 .btn-check:active +
 .btn-check:active + .btn-info {
   color: #5b62f4;
 ...
 .btn-check:checked + .btn-check:checked + .btn-warning,
 .btn-check:active + .btn-check:checked + .btn-warning, .btn-check:checked +
 .btn-check:active + .btn-warning,
 .btn-check:active +
 .btn-check:active + .btn-warning {
   color: #ffc107;
 ...
 .btn-check:active + .btn-check:checked + .btn-danger, .btn-check:checked +
 .btn-check:active + .btn-danger,
 .btn-check:active +
 .btn-check:active + .btn-danger {
   color: #e52527;
 ...
 .btn-check:active + .btn-check:checked + .btn-light, .btn-check:checked +
 .btn-check:active + .btn-light,
 .btn-check:active +
 .btn-check:active + .btn-light {
   color: #f0f5fa;
 ...
 .btn-check:checked + .btn-check:checked + .btn-dark,
 .btn-check:active + .btn-check:checked + .btn-dark, .btn-check:checked +
 .btn-check:active + .btn-dark,
 .btn-check:active +
 .btn-check:active + .btn-dark {
   color: #212529;
