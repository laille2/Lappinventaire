...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=CollectionEntity::class, mappedBy="user")
     */
    ...
    {
        if ($this->collectionEntitys->removeElement($collectionEntity)) {
            // set the owning side to null (unless already changed)
            if ($collectionEntity->getUser() === $this) {
